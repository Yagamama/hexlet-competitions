...
# They are from the range [1, 7], all did not appear in banned, and their 
...
if __name__ == '__main__':
    print(maxCount([1,6,5], n = 5, maxSum = 6))  # 2
    print(maxCount([1,2,3,4,5,6,7], n = 8, maxSum = 1))  # 0
    print(maxCount([11], n = 7, maxSum = 50))  # 7
