...
# You can do the following operation on the array any number of 
# times (possibly zero):
...
# Choose the elements at indices 0, 1 and 2. The resulting array 
# is nums = [1,0,0,1,0,0].
# Choose the elements at indices 1, 2 and 3. The resulting array 
# is nums = [1,1,1,0,0,0].
# Choose the elements at indices 3, 4 and 5. The resulting array 
# is nums = [1,1,1,1,1,1].
