...
# Explanation: 
# The elements 9, 5, and 3 are less than the pivot so they are on 
# the left side of the array.
# The elements 12 and 14 are greater than the pivot so they are on 
# the right side of the array.
# The relative ordering of the elements less than and greater than 
# pivot is also maintained. [9, 5, 3] and [12, 14] are the respective 
# orderings.
...
# Output: [-3,2,4,3]
# Explanation: 
# The element -3 is less than the pivot so it is on the left side 
# of the array.
