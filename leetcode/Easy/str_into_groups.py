...
# Explanation:
# Similar to the previous example, we are forming the first 
# three groups "abc", "def", and "ghi".
# For the last group, we can only use the character 'j' from 
# the string. To complete this group, we add 'x' twice.
